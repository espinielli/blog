...
date: '2018-01-03T15:00:00'
tags:
  - keyboard
slug: ergodox-keyboard
---
...
It all started with me reading [Steve Yegge's blog on touch typing](http://steve-yegge.blogspot.be/2008/09/programmings-dirtiest-little-secret.html)
...
* 14 x Case screws/nuts
  ...
  ```{r ed-kit, echo = FALSE}
  knitr::include_graphics("/img/ed-kit.png")
  ```
...
* Clear Ergodox DCS Keycaps (76 keys)
  ...
  knitr::include_graphics("/img/clear-keycaps.jpg")
  ```
...
knitr::include_graphics("/img/MD-15532_20160203111121_48a0debeb1e9cd0c.jpg")
```
...
So I went to the VUB University [Fablab](http://www.fablab-brussels.be/fablab-english/):
