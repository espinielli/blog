...
already done bits and pieces of what you need: [rtweet](http://rtweet.info/)
...
knitr::include_graphics("/img/comune_ggmap.jpg")
```
...
and I have found a nice solution (by [Robin Lovelace](http://www.robinlovelace.net/)) 
...
knitr::include_graphics("/img/comune_raster.jpg")
```
...
[gis2016wsg84]: http://www.istat.it/storage/cartografia/confini_amministrativi/archivio-confini/non_generalizzati/2016/Limiti_2016_WGS84.zip
